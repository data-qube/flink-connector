...
public class KDCodeTime {
    public static void main(String[] args) throws Exception {
        ...
        final  long timeoutMillis = 0L;//throughput tradeoff latency
        //final OutputTag<String> lateOutputTag = new OutputTag<String>("late-data"){};

        final  String sourceTopic ="hqtestzx";
        ...
        properties.setProperty("group.id", "kafka-codetime");
       ...
       // myConsumer.setStartFromLatest();
        ...
        DataStream<String> result = streamTuple.keyBy(0).timeWindow(windowTime,slideTime).allowedLateness(Latency)
                .apply(new KDTimeWindowCodeTime()).startNewChain().setParallelism(4);
        result.print();//addSink(produce);
        try {
