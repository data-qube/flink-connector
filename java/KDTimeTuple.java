 ...
 **/
public class KDTimeTuple extends RichWindowFunction<Tuple8<String,String, String,Double, Double, Double, Double,Long>, Tuple6<String,String, String,String, String, String>,
        Tuple, TimeWindow> {
    private transient ValueState<Tuple3<String, Double,Double>> sum;
    @Override
    public void apply(Tuple tuple, TimeWindow timeWindow, Iterable<Tuple8<String, String, String, Double, Double, Double, Double, Long>> iterable, Collector<Tuple6<String,String, String,String, String, String>> collector) throws Exception {
        Double MaxPrice = 0.0;
        Double MinPrice = 0.0;
        ...
        String  time = String.valueOf(timeWindow.getEnd());

        String ID =  new StringBuffer(result.f0+time+result.f2).reverse().toString();
        collector.collect(new Tuple6(ID,result.f0,result.f0,time,K.toString(),D.toString()));
