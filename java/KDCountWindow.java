 ...
 **/
public class KDCountWindow extends RichWindowFunction<Tuple8<String,String, String,Double, Double, Double, Double,Long>, String,
        Tuple, GlobalWindow> {
    private  final int windowSize = 12 ;
    private transient ValueState<Tuple3<String, Double,Double>> sum;
    @Override
    public void apply(Tuple tuple, GlobalWindow globalWindow, Iterable<Tuple8<String, String, String, Double, Double, Double, Double, Long>> iterable, Collector<String> collector) throws Exception {
            int count= 0;
            Double MaxPrice = 0.0;
            Double MinPrice = 0.0;
            ...
            //Date date =new Date(result.f2);
            //SimpleDateFormat formatter=new SimpleDateFormat("HHmmss");
            //String time = formatter.format(date);
           // System.out.println(currentSum.f1);
           // System.out.println(currentSum.f2);
            collector.collect(result.f1+","+result.f0+","+result.f2+","+K.toString()+","+D.toString());
